...
<div class="small-12 medium-3 columns">
	<select name="post[project_member]">saliva
		<option value=""><?php  _e('All Team members', RT_PM_TEXT_DOMAIN ) ?></option>
...
<div class="small-12 medium-3 columns">
	<select name="post[project_type]">
		<option value=""><?php  _e('All Project type', RT_PM_TEXT_DOMAIN ) ?></option>
		<?php
...
<div class="small-12 medium-3 columns">
	<select name="post[project_id]">
		<option value=""><?php _e( 'All Project', RT_PM_TEXT_DOMAIN ) ?></option>
		<?php
...
<br/><br/>
<div class="panel" style="overflow: auto;" data-project-id="<?php echo $project->ID; ?>" data-rt-blog-id="<?php echo get_current_blog_id() ?>">
