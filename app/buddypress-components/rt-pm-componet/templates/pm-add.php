...
if( !empty( $results_organization ) ) {
    foreach ( $results_organization as $organization ) {
    	if ( has_post_thumbnail($organization->ID) ) {
            ...
            $logo = get_the_post_thumbnail( $organization->ID, array( 24, 24 ) );
        } else{

            $logo = '<img src="'.RT_PM_URL.'app/buddypress-components/rt-pm-componet/assets/img/logo-default.png" width="24" height="24" class="attachment-32x32 wp-post-image"/>';
        }
