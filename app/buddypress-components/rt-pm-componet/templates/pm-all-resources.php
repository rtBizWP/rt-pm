...
if ( $the_query->have_posts() ) {
	...
	<div class="rt-main-resources-container rt-all-resources-container">
		...
		<div class="rt-right-container">
			...
			?>
			<a id="rtpm-get-prev-calender" class="rtpm-get-calender" href="#" data-flag="prev" data-date="<?php echo $first_date; ?>" data-calender="all-resources"><?php
				if ( wp_is_mobile() ) {
					echo "prev";
				} else {
					echo "<";
			...
			<a id="rtpm-get-next-calender" class="rtpm-get-calender" href="#" data-flag="next" data-date="<?php echo $last_date; ?>" data-calender="all-resources"><?php
				if ( wp_is_mobile() ) {
					echo "next";
				} else {
					echo ">";
