					...
					foreach ( $columns as $column_name => $column_display_name ) {
						...
						switch ( $column_name ) {
                            ...
                            case "rtpm_message":
                                ...
                                $actions = array(
                                    'edit'      => '<a class="rtpm_timeentry_edit" href="'.$rt_pm_bp_pm->get_component_root_url().bp_current_action() .'?post_type='.$rt_pm_project->post_type.'&'.$rt_pm_project->post_type.'_id='.$rec->project_id.'&tab='.$rt_pm_project->post_type.'-timeentry&'.$this->post_type.'_id='.$rec->id.'"'.'">Edit</a>',
