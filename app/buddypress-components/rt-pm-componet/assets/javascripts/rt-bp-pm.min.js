...
}).on("DOMNodeRemoved DOMAttrModified","["+this.attr_name()+"]:not(a)",function(){c.hide(d(this))})},ie_touch:function(){return!1},showTip:function(a){var b=this.getTip(a);return this.should_show(a,b)?this.show(a):void 0},getTip:function(b){var c=this.selector(b),d=a.extend({},this.settings,this.data_options(b)),e=null;return c&&(e=this.S('span[data-selector="'+c+'"]'+d.tooltip_class)),"object"==typeof e?e:!1},selector:function(a){var b=a.attr("id"),c=a.attr(this.attr_name())||a.attr("data-selector");return(b&&b.length<1||!b)&&"string"!=typeof c&&(c=this.random_str(6),a.attr("data-selector",c).attr("aria-describedby",c)),b&&b.length>0?b:c},create:function(c){var d=this,e=a.extend({},this.settings,this.data_options(c)),f=this.settings.tip_template;"string"==typeof e.tip_template&&b.hasOwnProperty(e.tip_template)&&(f=b[e.tip_template]);var g=a(f(this.selector(c),a("<div></div>").html(c.attr("title")).html())),h=this.inheritable_classes(c);g.addClass(h).appendTo(e.append_to),Modernizr.touch&&(g.append('<span class="tap-to-close">'+e.touch_close_text+"</span>"),g.on("touchstart.fndtn.tooltip MSPointerDown.fndtn.tooltip",function(){d.hide(c)})),c.removeAttr("title").attr("title","")},reposition:function(b,c,d){var e,f,g,h,i;if(c.css("visibility","hidden").show(),e=b.data("width"),f=c.children(".nub"),g=f.outerHeight(),h=f.outerHeight(),c.css(this.small()?{width:"100%"}:{width:e?e:"auto"}),i=function(a,b,c,d,e){return a.css({top:b?b:"auto",bottom:d?d:"auto",left:e?e:"auto",right:c?c:"auto"}).end()},i(c,b.offset().top+b.outerHeight()+10,"auto","auto",b.offset().left),this.small())i(c,b.offset().top+b.outerHeight()+10,"auto","auto",12.5,a(this.scope).width()),c.addClass("tip-override"),i(f,-g,"auto","auto",b.offset().left);else{var j=b.offset().left;Foundation.rtl&&(f.addClass("rtl"),j=b.offset().left+b.outerWidth()-c.outerWidth()),i(c,b.offset().top+b.outerHeight()+10,"auto","auto",j),c.removeClass("tip-override"),d&&d.indexOf("tip-top")>-1?(Foundation.rtl&&f.addClass("rtl"),i(c,b.offset().top-c.outerHeight(),"auto","auto",j).removeClass("tip-override")):d&&d.indexOf("tip-left")>-1?(i(c,b.offset().top+b.outerHeight()/2-c.outerHeight()/2,"auto","auto",b.offset().left-c.outerWidth()-g).removeClass("tip-override"),f.removeClass("rtl")):d&&d.indexOf("tip-right")>-1&&(i(c,b.offset().top+b.outerHeight()/2-c.outerHeight()/2,"auto","auto",b.offset().left+b.outerWidth()+g).removeClass("tip-override"),f.removeClass("rtl"))}c.css("visibility","visible").hide()},small:function(){return matchMedia(Foundation.media_queries.small).matches&&!matchMedia(Foundation.media_queries.medium).matches},inheritable_classes:function(b){var c=a.extend({},this.settings,this.data_options(b)),d=["tip-top","tip-left","tip-bottom","tip-right","radius","round"].concat(c.additional_inheritable_classes),e=b.attr("class"),f=e?a.map(e.split(" "),function(b){return-1!==a.inArray(b,d)?b:void 0}).join(" "):"";return a.trim(f)},convert_to_touch:function(b){var c=this,d=c.getTip(b),e=a.extend({},c.settings,c.data_options(b));0===d.find(".tap-to-close").length&&(d.append('<span class="tap-to-close">'+e.touch_close_text+"</span>"),d.on("click.fndtn.tooltip.tapclose touchstart.fndtn.tooltip.tapclose MSPointerDown.fndtn.tooltip.tapclose",function(){c.hide(b)})),b.data("tooltip-open-event-type","touch")},show:function(a){var b=this.getTip(a);"touch"==a.data("tooltip-open-event-type")&&this.convert_to_touch(a),this.reposition(a,b,a.attr("class")),a.addClass("open"),b.fadeIn(150)},hide:function(a){var b=this.getTip(a);b.fadeOut(150,function(){b.find(".tap-to-close").remove(),b.off("click.fndtn.tooltip.tapclose MSPointerDown.fndtn.tapclose"),a.removeClass("open")})},off:function(){var b=this;this.S(this.scope).off(".fndtn.tooltip"),this.S(this.settings.tooltip_class).each(function(c){a("["+b.attr_name()+"]").eq(c).attr("title",a(this).text())}).remove()},reflow:function(){}}}(jQuery,window,window.document),function(a,b,c){"use strict";Foundation.libs.topbar={name:"topbar",version:"5.4.6",settings:{index:0,sticky_class:"sticky",custom_back_text:!0,back_text:"Back",mobile_show_parent_link:!0,is_hover:!0,scrolltop:!0,sticky_on:"all"},init:function(b,c,d){Foundation.inherit(this,"add_custom_rule register_media throttle");var e=this;e.register_media("topbar","foundation-mq-topbar"),this.bindings(c,d),e.S("["+this.attr_name()+"]",this.scope).each(function(){var b=a(this),c=b.data(e.attr_name(!0)+"-init");e.S("section, .top-bar-section",this),b.data("index",0);var d=b.parent();d.hasClass("fixed")||e.is_sticky(b,d,c)?(e.settings.sticky_class=c.sticky_class,e.settings.sticky_topbar=b,b.data("height",d.outerHeight()),b.data("stickyoffset",d.offset().top)):b.data("height",b.outerHeight()),c.assembled||e.assemble(b),c.is_hover?e.S(".has-dropdown",b).addClass("not-click"):e.S(".has-dropdown",b).removeClass("not-click"),e.add_custom_rule(".f-topbar-fixed { padding-top: "+b.data("height")+"px }"),d.hasClass("fixed")&&e.S("body").addClass("f-topbar-fixed")})},is_sticky:function(a,b,c){var d=b.hasClass(c.sticky_class);return d&&"all"===c.sticky_on?!0:d&&this.small()&&"small"===c.sticky_on?matchMedia(Foundation.media_queries.small).matches&&!matchMedia(Foundation.media_queries.medium).matches&&!matchMedia(Foundation.media_queries.large).matches:d&&this.medium()&&"medium"===c.sticky_on?matchMedia(Foundation.media_queries.small).matches&&matchMedia(Foundation.media_queries.medium).matches&&!matchMedia(Foundation.media_queries.large).matches:d&&this.large()&&"large"===c.sticky_on?matchMedia(Foundation.media_queries.small).matches&&matchMedia(Foundation.media_queries.medium).matches&&matchMedia(Foundation.media_queries.large).matches:!1},toggle:function(c){var d,e=this;d=c?e.S(c).closest("["+this.attr_name()+"]"):e.S("["+this.attr_name()+"]");var f=d.data(this.attr_name(!0)+"-init"),g=e.S("section, .top-bar-section",d);e.breakpoint()&&(e.rtl?(g.css({right:"0%"}),a(">.name",g).css({right:"100%"})):(g.css({left:"0%"}),a(">.name",g).css({left:"100%"})),e.S("li.moved",g).removeClass("moved"),d.data("index",0),d.toggleClass("expanded").css("height","")),f.scrolltop?d.hasClass("expanded")?d.parent().hasClass("fixed")&&(f.scrolltop?(d.parent().removeClass("fixed"),d.addClass("fixed"),e.S("body").removeClass("f-topbar-fixed"),b.scrollTo(0,0)):d.parent().removeClass("expanded")):d.hasClass("fixed")&&(d.parent().addClass("fixed"),d.removeClass("fixed"),e.S("body").addClass("f-topbar-fixed")):(e.is_sticky(d,d.parent(),f)&&d.parent().addClass("fixed"),d.parent().hasClass("fixed")&&(d.hasClass("expanded")?(d.addClass("fixed"),d.parent().addClass("expanded"),e.S("body").addClass("f-topbar-fixed")):(d.removeClass("fixed"),d.parent().removeClass("expanded"),e.update_sticky_positioning())))},timer:null,events:function(){var c=this,d=this.S;d(this.scope).off(".topbar").on("click.fndtn.topbar","["+this.attr_name()+"] .toggle-topbar",function(a){a.preventDefault(),c.toggle(this)}).on("click.fndtn.topbar",'.top-bar .top-bar-section li a[href^="#"],['+this.attr_name()+'] .top-bar-section li a[href^="#"]',function(){var b=a(this).closest("li");!c.breakpoint()||b.hasClass("back")||b.hasClass("has-dropdown")||c.toggle()}).on("click.fndtn.topbar","["+this.attr_name()+"] li.has-dropdown",function(b){var e=d(this),f=d(b.target),g=e.closest("["+c.attr_name()+"]"),h=g.data(c.attr_name(!0)+"-init");return f.data("revealId")?void c.toggle():void(c.breakpoint()||(!h.is_hover||Modernizr.touch)&&(b.stopImmediatePropagation(),e.hasClass("hover")?(e.removeClass("hover").find("li").removeClass("hover"),e.parents("li.hover").removeClass("hover")):(e.addClass("hover"),a(e).siblings().removeClass("hover"),"A"===f[0].nodeName&&f.parent().hasClass("has-dropdown")&&b.preventDefault())))}).on("click.fndtn.topbar","["+this.attr_name()+"] .has-dropdown>a",function(a){if(c.breakpoint()){a.preventDefault();var b=d(this),e=b.closest("["+c.attr_name()+"]"),f=e.find("section, .top-bar-section"),g=(b.next(".dropdown").outerHeight(),b.closest("li"));e.data("index",e.data("index")+1),g.addClass("moved"),c.rtl?(f.css({right:-(100*e.data("index"))+"%"}),f.find(">.name").css({right:100*e.data("index")+"%"})):(f.css({left:-(100*e.data("index"))+"%"}),f.find(">.name").css({left:100*e.data("index")+"%"})),e.css("height",b.siblings("ul").outerHeight(!0)+e.data("height"))}}),d(b).off(".topbar").on("resize.fndtn.topbar",c.throttle(function(){c.resize.call(c)},50)).trigger("resize").trigger("resize.fndtn.topbar").load(function(){d(this).trigger("resize.fndtn.topbar")}),d("body").off(".topbar").on("click.fndtn.topbar",function(a){var b=d(a.target).closest("li").closest("li.hover");b.length>0||d("["+c.attr_name()+"] li.hover").removeClass("hover")}),d(this.scope).on("click.fndtn.topbar","["+this.attr_name()+"] .has-dropdown .back",function(a){a.preventDefault();var b=d(this),e=b.closest("["+c.attr_name()+"]"),f=e.find("section, .top-bar-section"),g=(e.data(c.attr_name(!0)+"-init"),b.closest("li.moved")),h=g.parent();e.data("index",e.data("index")-1),c.rtl?(f.css({right:-(100*e.data("index"))+"%"}),f.find(">.name").css({right:100*e.data("index")+"%"})):(f.css({left:-(100*e.data("index"))+"%"}),f.find(">.name").css({left:100*e.data("index")+"%"})),0===e.data("index")?e.css("height",""):e.css("height",h.outerHeight(!0)+e.data("height")),setTimeout(function(){g.removeClass("moved")},300)}),d(this.scope).find(".dropdown a").focus(function(){a(this).parents(".has-dropdown").addClass("hover")}).blur(function(){a(this).parents(".has-dropdown").removeClass("hover")})},resize:function(){var a=this;a.S("["+this.attr_name()+"]").each(function(){var b,d=a.S(this),e=d.data(a.attr_name(!0)+"-init"),f=d.parent("."+a.settings.sticky_class);if(!a.breakpoint()){var g=d.hasClass("expanded");d.css("height","").removeClass("expanded").find("li").removeClass("hover"),g&&a.toggle(d)}a.is_sticky(d,f,e)&&(f.hasClass("fixed")?(f.removeClass("fixed"),b=f.offset().top,a.S(c.body).hasClass("f-topbar-fixed")&&(b-=d.data("height")),d.data("stickyoffset",b),f.addClass("fixed")):(b=f.offset().top,d.data("stickyoffset",b)))})},breakpoint:function(){return!matchMedia(Foundation.media_queries.topbar).matches},small:function(){return matchMedia(Foundation.media_queries.small).matches},medium:function(){return matchMedia(Foundation.media_queries.medium).matches},large:function(){return matchMedia(Foundation.media_queries.large).matches},assemble:function(b){var c=this,d=b.data(this.attr_name(!0)+"-init"),e=c.S("section, .top-bar-section",b);e.detach(),c.S(".has-dropdown>a",e).each(function(){var b,e=c.S(this),f=e.siblings(".dropdown"),g=e.attr("href");f.find(".title.back").length||(b=a(1==d.mobile_show_parent_link&&g?'<li class="title back js-generated"><h5><a href="javascript:void(0)"></a></h5></li><li class="parent-link show-for-small"><a class="parent-link js-generated" href="'+g+'">'+e.html()+"</a></li>":'<li class="title back js-generated"><h5><a href="javascript:void(0)"></a></h5>'),a("h5>a",b).html(1==d.custom_back_text?d.back_text:"&laquo; "+e.html()),f.prepend(b))}),e.appendTo(b),this.sticky(),this.assembled(b)},assembled:function(b){b.data(this.attr_name(!0),a.extend({},b.data(this.attr_name(!0)),{assembled:!0}))},height:function(b){var c=0,d=this;return a("> li",b).each(function(){c+=d.S(this).outerHeight(!0)}),c},sticky:function(){var a=this;this.S(b).on("scroll",function(){a.update_sticky_positioning()})},update_sticky_positioning:function(){var a="."+this.settings.sticky_class,c=this.S(b),d=this;if(d.settings.sticky_topbar&&d.is_sticky(this.settings.sticky_topbar,this.settings.sticky_topbar.parent(),this.settings)){var e=this.settings.sticky_topbar.data("stickyoffset");d.S(a).hasClass("expanded")||(c.scrollTop()>e?d.S(a).hasClass("fixed")||(d.S(a).addClass("fixed"),d.S("body").addClass("f-topbar-fixed")):c.scrollTop()<=e&&d.S(a).hasClass("fixed")&&(d.S(a).removeClass("fixed"),d.S("body").removeClass("f-topbar-fixed")))}},off:function(){this.S(this.scope).off(".fndtn.topbar"),this.S(b).off(".fndtn.topbar")},reflow:function(){}}}(jQuery,window,window.document),jQuery(document).ready(function(a){function b(a,b){for(var c=b.find("thead td"),d=b.find("tbody tr"),e=a.find("thead tr"),f=0;f<c.length;f++)e.append(c[f]);for(var f=0;f<d.length;f++){var g=d[f],h=g.innerHTML;a.find("tbody tr:nth-child("+(f+1)+")").append(h)}return a}function c(b,c,d){for(var e=b.find("thead td"),f=c.find("thead td"),g='"',h=0;h<e.length;h++)var i=e[h].innerText,g=g+i+'","';for(var h=0;h<f.length;h++)var i=f[h].innerText,g=g+i+'","';for(var g=g+'"\r\n"',j=b.find("tbody tr"),k=c.find("tbody tr"),h=0;h<j.length;h++){for(var l=j[h].getElementsByTagName("td"),m=l[0].innerText,g=g+m+'","',n=k[h].getElementsByTagName("td"),o=0;o<n.length;o++)var p=n[o].innerText,g=g+p+'","';var g=g+'"\r\n"'}var g=g+'"',q="data:application/csv;charset=utf-8,"+encodeURIComponent(g);a(this).attr({download:d,href:q})}function d(){jQuery(".rtpm-show-tooltip").hover(function(a){var b=jQuery(".rt-right-container").offset();a.pageX+250>jQuery(window).width()?jQuery(this).parent().find(".rtpm-task-info-tooltip").css("display","block").css("top",a.pageY-b.top).css("left",a.pageX-b.left-200):jQuery(this).parent().find(".rtpm-task-info-tooltip").css("display","block").css("top",a.pageY-b.top).css("left",a.pageX-b.left)},function(){jQuery(this).parent().find(".rtpm-task-info-tooltip").css("display","none")})}function e(b,c){a(b).addClass("error"),a(b).next().length>0&&a(b).next().hasClass("error")?a(b).next().html(c):a(b).after("<small class='error'>"+c+"</small>")}function f(b){a(b).removeClass("error"),a(b).next().length>0&&a(b).next().hasClass("error")&&a(b).next().remove()}function g(a,b){var c="image"==a.type?a.url:a.icon;return"<li tabindex='0' role='checkbox' aria-label='6_webp' aria-checked='false' class='attachment save-ready document-attachment'><div class='attachment-preview js--select-attachment type-image subtype-png landscape'><div class='thumbnail'><div class='centered'><img src='"+c+"' draggable='false' alt=''></div></div><div class='filename'><div>"+a.title+"</div></div></div><a class='check document-check'  title='Deselect' tabindex='-1' data-document-id='"+b.attachment_id+"'><div class='media-modal-icon'></div></a></li>"}Foundation.global.namespace="",a(document).foundation(),exf_count=12345,a("#add_new_ex_file").click(function(){var b=a("#add_ex_file_title").val(),c=a("#add_ex_file_link").val();if(""==a.trim(c))return!1;a("#add_ex_file_title").val(""),a("#add_ex_file_link").val("");var d=' <div class="large-12 columns" >';d+='<div class="large-3 columns">',d+='<input type="text" name="project_ex_files['+exf_count+'][title]" value="'+b+'" />',d+='</div><div class="large-8 columns">',d+='<input type="text" name="project_ex_files['+exf_count+'][link]" value="'+c+'" />',d+='</div><div class="large-1 columns">',d+='<a class="button add-button removeMeta"><i class="fa fa-times"></i></a>',d+="</div></div>",exf_count++,a("#external-files-container").append(d)});var h={"#editor":function(){return!0}};a("#export-pdf").click(function(){var c=new jsPDF("p","pt","a4"),d=a("#item-body .rt-main-resources-container").clone();d.find(".rtpm-task-info-tooltip").remove();var e=a("#item-body .rt-left-container").clone();e.find(".rtpm-task-info-tooltip").remove();var f=a("#item-body .rt-right-container table").clone();f.find(".rtpm-task-info-tooltip").remove();var g=b(e,f);c.fromHTML(g.html(),10,10,{elementHandlers:h},function(){c.save("Resources.pdf")})}),jQuery("#export-csv").click(function(){c.apply(this,[a(".rt-left-container table"),a(".rt-right-container table"),"Resource.csv"])});try{void 0!=arr_project_member_user&&(jQuery("#project_member_user_ac").autocomplete({source:function(b,c){var d=a.ui.autocomplete.escapeRegex(b.term),e=new RegExp("^"+d,"i"),f=a.grep(arr_project_member_user,function(a){return e.test(a.label||a.value||a)}),g=new RegExp(d,"i"),h=a.grep(arr_project_member_user,function(b){return a.inArray(b,f)<0&&g.test(b.label||b.value||b)});c(f.concat(h))},focus:function(){},select:function(a,b){return jQuery("#project-member-auth-"+b.item.id).length<1&&jQuery("#divProjectMemberList").append("<li id='project-member-auth-"+b.item.id+"' class='contact-list' ><div class='row'><div class='small-2 column'>"+b.item.imghtml+"</div><div class='small-9 columns vertical-center'><a target='_blank' href='"+b.item.user_edit_link+"'>"+b.item.label+"</a></div><div class='small-1 columns vertical-center'><a href='#removeProjectMember' class='right'><i class='foundicon-remove'></i></a><input type='hidden' name='post[project_member][]' value='"+b.item.id+"' /></div></div></li>"),jQuery("#project_member_user_ac").val(""),!1}}).data("ui-autocomplete")._renderItem=function(b,c){return a("<li></li>").data("ui-autocomplete-item",c).append("<a class='ac-project-member-selected'>"+c.imghtml+"&nbsp;"+c.label+"</a>").appendTo(b)},jQuery(document).on("click","a[href=#removeProjectMember]",function(b){b.preventDefault(),a(this).parent().parent().parent().remove()}))}catch(j){}jQuery(".rtpm-get-calender").click(function(){var a=jQuery(this).data("date"),b=jQuery(this).data("flag"),c=jQuery(this).data("calender");jQuery.ajax({type:"POST",dataType:"json",url:ajaxurl,data:{action:"rtpm_get_resources_calender",date:a,flag:b,calender:c},success:function(a){a.fetched&&(jQuery("#rtpm-resources-calender").empty(),jQuery("#rtpm-resources-calender").append(a.html),jQuery("#rtpm-get-next-calender").data("date",a.nextdate),jQuery("#rtpm-get-prev-calender").data("date",a.prevdate),d())}})}),d(),jQuery(".rtpm-show-user-tooltip").hover(function(a){var b=jQuery(".rt-left-container").offset();jQuery("#item-body").css("overflow","visible"),jQuery(this).parent().find(".rtpm-task-info-tooltip").css("display","block").css("top",a.pageY-b.top).css("left",a.pageX-b.left)},function(){jQuery(window).width()<680&&jQuery("#item-body").css("overflow","hidden"),jQuery(this).parent().find(".rtpm-task-info-tooltip").css("display","none")});try{void 0!=arr_project_organization&&(jQuery("#project_org_search_account").autocomplete({source:function(b,c){var d=a.ui.autocomplete.escapeRegex(b.term),e=new RegExp("^"+d,"i"),f=a.grep(arr_project_organization,function(a){return e.test(a.label||a.value||a)}),g=new RegExp(d,"i"),h=a.grep(arr_project_organization,function(b){return a.inArray(b,f)<0&&g.test(b.label||b.value||b)});c(f.concat(h))},focus:function(){},select:function(a,b){return jQuery("#project-org-auth-"+b.item.id).length<1&&jQuery("#divProjectAccountsList").append("<li id='project-org-auth-"+b.item.id+"' class='contact-list' ><div class='row'><div class='column small-2'>"+b.item.imghtml+"</div><div class='column small-9 vertical-center'><a target='_blank' href='"+b.item.user_edit_link+"'>"+b.item.label+"</a></div><div class='column small-1 vertical-center'><a href='#removeProjectOrganization' class='right'><i class='foundicon-remove'></i></a><input type='hidden' name='post[project_organization][]' value='"+b.item.id+"' /></div></div></li>"),jQuery("#project_org_search_account").val(""),!1}}).data("ui-autocomplete")._renderItem=function(b,c){return a("<li></li>").data("ui-autocomplete-item",c).append("<a class='ac-project-client =-selected'>"+c.imghtml+"&nbsp;"+c.label+"</a>").appendTo(b)},jQuery(document).on("click","a[href=#removeProjectOrganization]",function(b){b.preventDefault(),a(this).parent().parent().parent().remove()}))}catch(j){console.log(j)}try{void 0!=arr_project_client_user&&(jQuery("#project_client_user_ac").autocomplete({source:function(b,c){var d=a.ui.autocomplete.escapeRegex(b.term),e=new RegExp("^"+d,"i"),f=a.grep(arr_project_client_user,function(b){if(a("input[name*='post[project_organization]']").length>0){for(org=new Array,a.each(a("input[name*='post[project_organization]']"),function(b,c){org.push(parseInt(a(c).val()))}),flag=!1,i=0;i<org.length;i++)a.inArray(org[i],b.organization)||(flag=!0);if(!flag)return!1}return e.test(b.label||b.value||b)}),g=new RegExp(d,"i"),h=a.grep(arr_project_client_user,function(b){if(a("input[name*='post[project_organization]']").length>0){for(org=new Array,a.each(a("input[name*='post[project_organization]']"),function(b,c){org.push(parseInt(a(c).val()))}),flag=!1,i=0;i<org.length;i++)a.inArray(org[i],b.organization)||(flag=!0);if(!flag)return!1}return a.inArray(b,f)<0&&g.test(b.label||b.value||b)});c(f.concat(h))},focus:function(){},select:function(a,b){return jQuery("#project-client-auth-"+b.item.id).length<1&&jQuery("#divProjectClientList").append("<li id='project-client-auth-"+b.item.id+"' class='contact-list' ><div class='row'><div class='small-2 column'>"+b.item.imghtml+"</div><div class='small-9 columns vertical-center'><a target='_blank' href='"+b.item.user_edit_link+"'>"+b.item.label+"</a></div><div class='small-1 columns vertical-center'><a href='#removeProjectClient' class='right'><i class='foundicon-remove'></i></a><input type='hidden' name='post[project_client][]' value='"+b.item.id+"' /></div></div></li>"),jQuery("#project_client_user_ac").val(""),!1}}).data("ui-autocomplete")._renderItem=function(b,c){return a("<li></li>").data("ui-autocomplete-item",c).append("<a class='ac-project-client =-selected'>"+c.imghtml+"&nbsp;"+c.label+"</a>").appendTo(b)},jQuery(document).on("click","a[href=#removeProjectClient]",function(b){b.preventDefault(),a(this).parent().parent().parent().remove()}))}catch(j){}a(".datetimepicker").length>0&&a(".datetimepicker").datetimepicker({dateFormat:"M d, yy",timeFormat:"hh:mm TT"}),a(".datepicker").length>0&&a(document).on("focus",".datepicker",function(){a(this).datepicker({dateFormat:"dd/mm/yy"})}),a(document).on("click",".moment-from-now",function(){var b=a(this).attr("title");""!=b&&a(this).datepicker("setDate",new Date(a(this).attr("title")))}),a(".datepicker-toggle").click(function(){a(this).parent("div").prev().find(".hasDatepicker").click(),a(this).parent("div").prev().find(".hasDatepicker").datepicker("show")}),a("#button-trash").click(function(){var b=confirm("Are you sure you want to move this project to trash?");return 1!=b?!1:(window.location=a(this).data("href"),!1)}),a("a.close").on("click",function(b){b.preventDefault(),a(this).parent().remove()}),a("#form-add-post").submit(function(b){try{var c=a("#new_"+a(this).data("posttype")+"_title");if(""==a(c).val().trim())return e(c,"Please Enter the Title"),!1;var d=a("#create_"+a(this).data("posttype")+"_date");if("rt_task"==a(this).data("posttype")){var g=a("#due_"+a(this).data("posttype")+"_date");if(a(g).datepicker("getDate")<=a(d).datepicker("getDate"))return e(g,"Please Enter valid Date"),!1;f(g)}else if("rt_time_entry"==a(this).data("posttype")){var h=new Date;if(h<a(d).datepicker("getDate"))return e(d,"Please Enter valid Date"),!1;f(d)}f(c)}catch(b){return console.log(b),!1}}),jQuery(document).on("click",".rtpm_delete_attachment",function(a){a.preventDefault(),jQuery(this).parents("tr").remove()});var k;jQuery("#add_pm_attachment").on("click",function(a){return a.preventDefault(),k?void k.open():(k=wp.media.frames.file_frame=wp.media({title:jQuery(this).data("uploader_title"),searchable:!0,button:{text:"Attach Selected Files"},multiple:!0}),k.on("select",function(){var a=k.state().get("selection"),b="";a.map(function(a){a=a.toJSON(),b='<tr class="large-12 mobile-large-3 attachment-item" data-attachment-id="'+a.id+'">',b+='<td scope="column"><img height="20px" width="20px" src="'+a.icon+'"'+a.filename+'" /></td>',b+='<td scope="column"><a target="_blank" href="'+a.url+'"> '+a.filename+"</a></td>",b+='<td scope="column"><span>&nbsp;&nbsp;&nbsp;</span></td>',b+='<td scope="column"><a href="#" class="rtpm_delete_attachment right">x</a>',b+='<input type="hidden" name="attachment[]" value="'+a.id+'" /></td></tr>',jQuery("#attachment-container .scroll-height table").append(b)})}),void k.open())}),jQuery("#add_project_attachment").on("click",function(b){b.preventDefault();var c=a(this).data("projectid");return k?void k.open():(k=wp.media.frames.file_frame=wp.media({title:jQuery(this).data("uploader_title"),searchable:!0,button:{text:"Attach Selected Files"},multiple:!0}),k.on("select",function(){var b=k.state().get("selection"),d="";b.map(function(b){b=b.toJSON(),d='<div class="large-12 mobile-large-3 columns attachment-item" data-attachment-id="'+b.id+'">',d+='<a target="_blank" href="'+b.url+'"><img height="20px" width="20px" src="'+b.icon+'" > '+b.filename+"</a>",d+='<a href="#" data-attachmentid="'+b.id+'" class="rtpm_delete_project_attachment right">x</a>',d+='<input type="hidden" name="attachment[]" value="'+b.id+'" /></div>',jQuery("#attachment-container .scroll-height").append(d),a.ajax({url:ajaxurl,dataType:"json",type:"post",data:{action:"rtpm_add_attachement",project_id:c,attachment_id:b.id},success:function(){}})})}),void k.open())}),jQuery(document).on("click",".rtpm_delete_project_attachment",function(b){b.preventDefault();var c=a("#add_project_attachment").data("projectid");"undefined"==typeof c&&(c=a("#project_id").val());var d=a(this).data("attachmentid");a.ajax({url:ajaxurl,type:"post",data:{action:"rtpm_remove_attachment",project_id:c,attachment_id:d},success:function(){a("#attachment-error").removeClass()}}),jQuery(this).parent().parent().remove()}),a(document).on("click",".add-task",function(){a("#div-add-task").reveal({opened:function(){}})});try{"undefined"!=typeof jQuery("input.search-contact")&&(jQuery("input.search-contact").autocomplete({source:function(b,c){a.ajax({url:ajaxurl,dataType:"json",type:"post",data:{action:"rtbiz_search_person",query:b.term},success:function(b){b.success&&c(a.map(b.data,function(a){return{id:a.contact_wp_user_id,label:a.contact_display_name,imghtml:a.contact_imghtml}}))}})},minLength:2,select:function(a,b){return jQuery(this).val(b.item.label),jQuery(this).siblings("input.contact-wp-user-id").val(b.item.id),!1}}).data("ui-autocomplete")._renderItem=function(b,c){return a("<li></li>").data("ui-autocomplete-item",c).append("<a class='ac-subscribe-selected'>"+c.imghtml+"&nbsp;"+c.label+"</a>").appendTo(b)})}catch(j){}a(document).on("click",".add-time-entry",function(){a("#div-add-time-entry").reveal({opened:function(){}})}),a(document).on("click",".add-external-link",function(){a("#div-add-external-link").reveal({opened:function(){}})}),a(".deletepostlink").click(function(){var a=confirm("Are you sure you want to delete this?");return 1!=a?!1:void 0}),a("#rtpm_post_status").on("change",function(){"closed"==a(this).val()?a("#rtpm_closing_reason_wrapper").show():a("#rtpm_closing_reason_wrapper").hide()}),a("span.rtpm_readmore").readmore({speed:75,maxHeight:20,sectionCSS:"display: inline-block;"}),a("#top-button-trash").click(function(){var b=confirm("Are you sure you want to move this project to trash?");return 1!=b?!1:(window.location=a(this).data("href"),!1)}),a("#button-archive").click(function(){var b=confirm("Are you sure you want to move this project to archive?");return 1!=b?!1:(window.location=a(this).data("href"),!1)}),a("#button-unarchive").click(function(){var b=confirm("Are you sure you want to move this project to unarchive?");return 1!=b?!1:(window.location=a(this).data("href"),!1)}),a("#top-button-archive").click(function(){var b=confirm("Are you sure you want to move this project to archive?");return 1!=b?!1:(window.location=a(this).data("href"),!1)}),a("#top-button-unarchive").click(function(){var b=confirm("Are you sure you want to move this project to unarchive?");return 1!=b?!1:(window.location=a(this).data("href"),!1)}),a(".add-task").click(function(){a(".add-task").text("Update Task")}),a(".add-task").click(function(){a(".add-task").text("Update Task")}),a(".add-time-entry").click(function(){a(".add-time-entry").text("Update Time Entry")}),a(document).on("click",".removeMeta",function(){a(this).parent().parent().remove()}),a("#add_ex_file_title").change(function(){var b=a("#add_ex_file_title").val();a("#add_modal_title").val(b)}),a("#add_ex_file_link").change(function(){var b=a("#add_ex_file_link").val();a("#add_modal_link").val(b)});var l;a("#upload_image").on("click",function(b){return b.preventDefault(),l?void l.open():(l=wp.media.frames.file_frame=wp.media({title:"Choose Documents",button:{text:"Choose Documents"},multiple:!0}),l.on("select",function(){attachments=l.state().get("selection").toJSON(),filenames=[],a.each(attachments,function(b,c){var d={attachment_id:c.id,action:"rtbiz_add_new_documents",post_id:a("#rt_pm_post_id").val(),filename:c.url,blog_id:a("#rt-pm-blog-id").val()};console.log(d),a.post(ajaxurl,d,function(b){a("#attachment-document").prepend(g(c,b))},"json")})}),void l.open())}),a(document).on("click","li.document-attachment",function(){var b=a(this).attr("aria-checked");if("false"==b){a("#attachment-document>li.document-attachment").attr("aria-checked","false"),a("#attachment-document>li.document-attachment").removeClass(" details selected"),a(this).attr("aria-checked","true"),a(this).addClass(" details selected");var c=a(this).find("a").data("document-id");a(".actions").data("attachment-id",c);var d={action:"rtattachment_metadata",attachment_id:c};a.post(ajaxurl,d,function(b){a(".filetype").html("<strong>File type: </strong> "+b.post_mime_type),a(".uploaded").html(" <strong>Uploaded on: </strong>"+b.post_modified),a("#fileurl").val(b.guid),a("#filetitle").val(b.post_title),a("#filecaption").val(b.post_excerpt),a("#filedescription").val(b.post_content),a(".details>a").attr("href",b.guid)},"json")}else a(".filetype").html(""),a(".uploaded").html(""),a("#fileurl").val(""),a("#filetitle").val(""),a("#filecaption").val(""),a("#filedescription").val(""),a(".details>a").attr("href","#"),a(this).attr("aria-checked","false"),a(this).removeClass(" details selected")}),a("#save-attachment").on("click",function(){var b=a(".actions").data("attachment-id"),c={action:"rtattachment_save_data",ID:b,post_title:a("#filetitle").val(),post_excerpt:a("#filecaption").val(),post_content:a("#filedescription").val()};a.post(ajaxurl,c,function(b){b>0&&($element=a("#attachment-document>li.document-attachment.details.selected"),$element.find(".filetitle").html(a("#filetitle").val()))})}),a("#delete-attachment").live("click",function(){var b=a(".actions").data("attachment-id"),c={action:"rtbiz_remove_document",attachment_id:b};a.post(ajaxurl,c,function(){$element=a("#attachment-document>li.document-attachment.details.selected"),$element.remove(),a(".filetype").html(""),a(".uploaded").html(""),a("#fileurl").val(""),a("#filetitle").val(""),a("#filecaption").val(""),a("#filedescription").val(""),a(".details>a").attr("href","#")})}),a("ul.attachments").on("click","a.document-check",function(b){b.preventDefault(),$element=a(this).parent();var c={action:"rtbiz_remove_document",attachment_id:a(this).data("document-id")};a.post(ajaxurl,c,function(){$element.remove()})}),a(document).on("click","a.add-multiple",function(){$main_div=a(this).parents("div.rt-row"),$input=$main_div.find("input");var b=$input.filter(function(){return""===a.trim(this.value)});return b.length?!1:($element=$main_div.clone(),$element.find("a").removeClass("add-multiple").addClass("delete-multiple").find("i").removeClass("fa fa-plus").addClass("fa fa-times"),$parent=a(this).parents("div.rt-parent-row").append($element),void $input.val(""))}),a(document).on("click","a.delete-multiple",function(){a(this).parents("div.rt-row").remove()})});