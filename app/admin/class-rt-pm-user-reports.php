...
if ( ! class_exists( 'Rt_PM_User_Reports' ) ) {
	...
	class Rt_PM_User_Reports {
		...
		function register_custom_pages() {
			...
			add_submenu_page( 'edit.php?post_type='.$rt_pm_project->post_type, __( 'User Reports' ), __( 'User Reports' ), 'run_user_reports', self::$user_reports_page_slug, array( $this, 'ui' ) );
		}
