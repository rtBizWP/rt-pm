            ...
            if ($project_list_query->have_posts()) {
                ...
                <div class="tablenav top">
                    <div class="view-switch">
                        <a href="<?php echo admin_url("edit.php?post_type=rt_project&mode=list"); ?>" <img id="view-switch-list" src="http://rtbiz.local.com/wp-includes/images/blank.gif" width="20" height="20" title="List View" alt="List View"></a>
                        <a href="<?php echo admin_url("edit.php?post_type=rt_project&page=rtpm-all-rt_project&mode=cart"); ?>"  class="current"><img id="view-switch-excerpt" src="http://rtbiz.local.com/wp-includes/images/blank.gif" width="20" height="20" title="Excerpt View" alt="Excerpt View"></a>
                    </div>
                </div>
                <?php
